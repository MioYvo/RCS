...
from Access.settings import MONGO_URI, REDIS_HOST, REDIS_PORT, REDIS_DB, REDIS_PASS, PROJECT_NAME, MONGO_DB, \
...
cache = Cache(
    ...
    namespace=PROJECT_NAME, db=REDIS_DB, password=REDIS_PASS
)
